...
# 访问私有属性会报错 AttributeError: 'Student2' object has no attribute '__password'
# 但是有的时候我们又想获取对象的信息。
...
stu1 = Student3('小明', 90, '男','123456')
print(stu1.get_score())

stu1.set_score(100)
print(stu1.get_score())

# stu1.__score = 100          # 私有属性不能直接被修改
# print(stu1.get_score())
# java中类每个属性都有getter setter方法
# getter和setter函数可以提供更加精细的控制。

# 4. (了解 语法糖)property(装饰器)
